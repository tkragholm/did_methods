...
test_that("att_gt works with 2 groups", {
  ...
  csdid_nyt_universal <- did::att_gt(
    yname = "y",
    idname = "id",
    gname = "g",
    tname = "t",
  ...
  expect_equal(
    csdid_nyt_universal$att[2],
    csdid_nt_universal$att[2],
    tol = .0001
  )
  expect_equal(
    csdid_nyt_universal$att[2],
    csdid_nyt_varying$att[2],
    tol = .0001
  )
